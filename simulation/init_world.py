...
# the parameter of cloth
cloth_position = np.array([0, -0.5, 1])
...
# cloth_orig_pos = [1.py, 1.py, 3]  # np.array([0.34658437, -0.30296362, 1.py.20023387])
...
#                                      useMaximalCoordinates=1.py)
#
# cloth_id = p.loadCloth(cloth_path, scale=1.py.0, mass=0.23,
#                        position=np.array([-0.03, -0.2, 1.py]),
...
#                        collisionMargin=0.04, rgbaColor=np.array([1.py, 0.5, 0.5, 1.py]),
#                        rgbaLineColor=np.array([0, 0.5, 0, 1.py]))
#
# print(p.getCameraImage(128, 128))
#
# with open('1.py.txt', 'w') as fout:
